...
config_path = r'C:\Users\lenovo\Desktop\Projects\ObjectDetection-master\ObjectDetection-master\config_n_weights\yolov3_latest.cfg'
weights_path = r'C:\Users\lenovo\Desktop\Projects\ObjectDetection-master\ObjectDetection-master\config_n_weights\yolov3_last.weights'
...
def object_detection_video():
    ...
    font_scale = 1
    thickness = 1
    f = open(r'C:\Users\lenovo\Desktop\Projects\ObjectDetection-master\ObjectDetection-master\models\classes.txt','r')
    lines = f.readlines()
    ...
    on = [ln[i - 1] for i in net.getUnconnectedOutLayers()]
...
def main():
    new_title = '<p style="font-size: 42px;">Object Detection App</p>'
    read_me_0 = st.markdown(new_title, unsafe_allow_html=True)

    read_me = st.markdown("""
    This project was built using Streamlit and OpenCV 
    to demonstrate YOLO Object detection in both videos
    and images.
    
    Here currently we have build model using YOLOV3 using darknet architecture
    
    
    This YOLO object Detection project can detect 10 objects(i.e classes)
